...
class PurchaseController extends Controller
{
    ...
    public function index()
    {
        $purchases = DB::table('purchases')
                    ...
                    ->get();
        return view('admin.purchase.list', ['purchases' => $purchases]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.purchase.purchase', compact('products', 'purchases', 'suppliers', 'shippers'));
    }
    ...
    public function store(Request $request)
    {
        DB::transaction(function() use ($request){   
            ...
            return redirect('/admin/purchases')->with('status', 'purchase Successful');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.purchase.detail', ['purchases' => $purchases,'purchase_details' => $purchase_details]);
    }
