                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="floatingName">Customer Name <span style="color:red">*</span></label>
                                    <select name="customer_id" id="customer_id" class="form-control form-select customer_id">
                                    ...
                                    <div class="row">
                                        <div class="form-floating">
                                            <input type="date" class="form-control" placeholder="dd-mm-yyyy" name="order_date">
                                            <label for="inputDate" class="mx-2 col-form-label">Order Date</label>
                                        </div>
                                    </div>
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-primary text-white text-center">
                            <h4 style="float: left">Products Order</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="product_id[]" id="product_id" class="form-control form-select product_id">
                                                ...
                                                <option data-price="{{ $product->sale_price }}" data-alert-stock="{{ $product->alert_stock }}" value="{{$product->id}}">{{$product->product_name}}</option>
                                                @endforeach
                                            </select>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="save">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <a href="{{ route('orders.index')}}"><div class="w-100 btn btn-danger btn-lg btn-block mt-3 text-light">Cancel</div></a>
                                                            </div>
