    ...
    <div class="col-lg-12">
      <div class="row">
        <table class="table datatable table-striped">
          <div class="row">
            <div class="col-9">
              <h4 class="col-md-6" style="float: left; font-size: 40px;"><i class="bi bi-person-down"></i></h4>
            </div>
            <div class="col-3">
              <a href="" style="float: right" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#Addcustomer"><i class="bi bi-plus-square-dotted"></i> Add New Customer</a>
            </div>
          </div>
          <thead>
            <tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="row g-3 d-flex" action="{{ route('customers.update',$customer->id) }}" method="post">
                      @csrf
                      @method('PUT')
                      <div class="row py-2">
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" value="{{ $customer->customer_name }}" id="floatingName" name="customer_name" placeholder="User Name">
                            <label for="floatingName">User Name</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="email" class="form-control" value="{{ $customer->email }}" name="email" id="floatingEmail" placeholder="Your Email">
                      ...
                      <div class="row py-2">
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="first_name" value="{{ $customer->first_name }}" id="floatingFirstName" placeholder="First Name">
                            <label for="floatingFirstName">First Name</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="last_name" value="{{ $customer->last_name }}" id="floatingLastName" placeholder="Last Name">
                      ...
                      <div class="row py-2">
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="company" value="{{ $customer->company }}" id="floatingCompany" placeholder="Company">
                            <label for="floatingLastName">Company</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="job_title" value="{{ $customer->job_title }}" id="floatingJob" placeholder="Job Title">
                      ...
                      <div class="row py-2">
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="phone_number" value="{{ $customer->phone_number }}" id="floatingPhone" placeholder="Phone Number">
                            <label for="floatingPhone">Phone Number</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="webpage" value="{{ $customer->webpage }}" id="floatingWebpage" placeholder="Webpage">
                      ...
                      <div class="row py-2">
                        <div class="col-md-6">
                          <div class="col-md-12">
                            <div class="form-floating">
                              <input type="text" class="form-control" value="{{ $customer->street }}" name="street" id="floatingStreet" placeholder="Street">
                        ...
                        <div class="col-md-6">
                          <div class="col-md-12">
                            <div class="form-floating">
                              <input type="text" class="form-control" value="{{ $customer->city }}" name="city" id="floatingCity" placeholder="City">
                      ...
                      <div class="row py-2">
                        <div class="col-md-4">
                          <div class="form-floating mb-3">
                            <input class="form-control" name="country" value="{{ $customer->country }}" id="floatingSelect" placeholder="Country">
                            <label for="floatingSelect">Country</label>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-floating mb-3">
                            <input class="form-control" name="province" value="{{ $customer->province }}" id="floatingSelect" placeholder="Province">
                        ...
                        <div class="col-md-4">
                          <div class="form-floating">
                            <input type="text" class="form-control" value="{{ $customer->zip_code }}" name="zip_code" id="floatingZip" placeholder="Zip">
                      ...
                      <div class="col-12">
                        <div class="form-floating">
                          <textarea class="form-control" value="{{ $customer->note }}" name="note" placeholder="Note" id="floatingTextarea" style="height: 100px;"></textarea>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="row g-3" action="{{ route('customers.store') }}" method="post">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="floatingName" name="customer_name" placeholder="User Name">
              <label for="floatingName">User Name</label>
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-4">
            <div class="form-floating mb-3">
              <input class="form-control" name="country" id="floatingSelect" placeholder="Country">
              <label for="floatingSelect">Country</label>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-floating mb-3">
              <input class="form-control" name="province" id="floatingSelect" placeholder="Province">
              <label for="floatingSelect">State</label>
            </div>
          </div>
          <div class="col-md-4">
