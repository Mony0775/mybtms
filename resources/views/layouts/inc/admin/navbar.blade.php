<div class="d-flex align-items-center justify-content-between" >
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" role="search" method="GET" action="{{ route('searches.index') }}">
        <input type="text" name="search" value="" placeholder="Search Transaction" title="Enter search keyword">
