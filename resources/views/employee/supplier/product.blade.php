              ...
              <td>
                <div class="btn-group">
                  <div class="mx-3 align-center">
                    ...
                    <a href="" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#Deleteproduct{{ $product->id }}"><i class="bi bi-trash"></i></a>
                  </div>
                </div>
              </td>
            </tr>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="row g-3 d-flex" action="{{ route('product.update',$product->id) }}" method="post" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
