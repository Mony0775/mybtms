      ...
      <div class="row">
        <div class="card">
          <div class="card-header">
            <a href="{{ route('order.create') }}" style="float: right" class="btn btn-dark"><i class="bi bi-plus"></i> Add New Order</a>
          </div>
          <table class="table datatable table-striped">
            ...
            <tbody>
              ...
              <!-- Delete Modal -->
              <div class="modal right fade" id="Deleteorder{{ $order_details->order_id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
