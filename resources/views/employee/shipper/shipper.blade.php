                ...
                @foreach($shippers as $key => $shipper)
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <div class="mx-2">
                          <a href="" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#Editshipper{{ $shipper->id }}"><i class="bi bi-pencil"></i></a>
                          <a href="" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#Deleteshipper{{ $shipper->id }}"><i class="bi bi-trash"></i></a>
                        </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form class="row g-3 d-flex" action="{{ route('shipper.update',$shipper->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row py-2">                            
                              <div class="col-md-6">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form class="row g-3" action="{{ route('shipper.store') }}" method="post">
              @csrf
                <div class="col-md-6">
                  <div class="form-floating">
