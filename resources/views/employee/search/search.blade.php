              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="row btn-group mx-2">
                    <div class="mx-3">
                      <a href="/employee/order/{{ $search->order_id }}" class="btn btn-sm btn-warning"><i class="bi bi-eye"></i></a>
                    </div>
                  </div>
                  @else
                  <div class="row btn-group mx-2">
                    <div class="mx-3">
                      <a href="/employee/purchase/{{ $search->purchase_id }}" class="btn btn-sm btn-warning"><i class="bi bi-eye"></i></a>
                    </div>
                  </div>
                  @endif
                </td>
